...
/*Class Input*/
#define Input_GetTouch (uintptr_t) IL2Cpp::Il2CppGetMethodOffset("UnityEngine.dll", "UnityEngine", "Input", "GetTouch", 1)
#define Input_get_touchSupported (uintptr_t) IL2Cpp::Il2CppGetMethodOffset("UnityEngine.dll", "UnityEngine", "Input", "get_touchSupported")
#define Input_get_touchCount (uintptr_t) IL2Cpp::Il2CppGetMethodOffset("UnityEngine.dll", "UnityEngine", "Input", "get_touchCount")
#define Input_get_mousePosition (uintptr_t) IL2Cpp::Il2CppGetMethodOffset("UnityEngine.dll", "UnityEngine", "Input", "get_mousePosition")
